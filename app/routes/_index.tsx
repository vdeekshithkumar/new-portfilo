    ...
    >
      ...
      {index === currentImageIndex && (
        <motion.div
          ...
          className="absolute top-3 sm:top-5 left-3 sm:left-5 text-xs sm:text-sm md:text-lg font-semibold text-white bg-black bg-opacity-60 px-3 sm:px-4 py-1 rounded-br-lg"
        >
